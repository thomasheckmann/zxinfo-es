...
echo "- SC/zxdb assets"
rsync -avz ../../zxinfo-hash-check/files/spectrumcomputing.co.uk/zxdb -e 'ssh -i ~/.ssh/thishost-rsync-key' kolbeck@zxinfo.dk:/www/sinclair/media
echo "- SC/pub assets"
rsync -avz ../../zxinfo-hash-check/files/spectrumcomputing.co.uk/pub -e 'ssh -i ~/.ssh/thishost-rsync-key' kolbeck@zxinfo.dk:/www/sinclair/media
